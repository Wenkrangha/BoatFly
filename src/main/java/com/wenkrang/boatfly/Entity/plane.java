...
public class plane {
    ...
    public static void getplane(Location location) {
        Boat boat = (Boat) location.getWorld().spawnEntity(location, EntityType.valueOf(
    ...
    public static void getplanelevetwo(Location location) {
        org.bukkit.entity.Boat boat =  (Boat) location.getWorld().spawnEntity(location, EntityType.valueOf(
                VersionChecker.isVersionBelow("1.21.2") ? "BOAT" : "OAK_BOAT"
        ));
        boat.addScoreboardTag("CanFly");
        boat.addScoreboardTag("eng0");
